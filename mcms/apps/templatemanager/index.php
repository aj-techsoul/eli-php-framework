...
<section class="header g g1a m1a s1 xs1">
  ...
  <div class="g g2 ggap">
    ...
    <span class="btn blue mdi mdi-floppy" onclick="validSubmit('#addPG')" > SAVE</span>
  </div>
</section>
...
<section class="formbox g g1a m1a s1 xs1">
  ...
  <form action="CMS/p/templatemanager/addtemplate" method="post" enctype="multipart/form-data" id="addPG" >
      ...
      <textarea id="contentArea" name="content" rows="20" class="default" required > <?php echo base64_decode(@$c['content']); ?> </textarea>
