<?php
session_start();
$rfmpath = str_replace("dialog.php","",$_SERVER['SCRIPT_NAME']); 
$rfmpath = str_replace("upload.php","",$_SERVER['SCRIPT_NAME']); 
//echo "<pre>";
//print_r($GLOBALS);
$root2 = str_replace("mcms/apps/rfm/filemanager/dialog.php", "", $_SERVER['SCRIPT_FILENAME']);
$root2 = str_replace("mcms/apps/rfm/filemanager/upload.php", "", $root2);
$root2 = str_replace("mcms/apps/rfm/filemanager/ajax_calls.php", "", $root2);
$root2 = str_replace("mcms/apps/rfm/filemanager/execute.php", "", $root2);
//echo $root2;
include($root2.'ELI/define.php');
$http = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
$rpath = str_replace("/".@$websitepath,"",@$rfmpath);
$baseurl = $root2;
$base2 = $http."://".$_SERVER["SERVER_NAME"]."/".@$websitepath;
$base_url = $base2;
$version = "9.13.2";
if (session_id() == '') session_start();
if(@$_SESSION['cms']['active']!='y'){
	die('Sorry not accessible');
}
...
$config = array(
	...
	|
	*/
	// 'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://".$_SERVER['SERVER_NAME']."/".$websitepath."/",
	'base_url' => $base_url,
	/*
	|--------------------------------------------------------------------------
